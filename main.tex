...
\begin{itemize}
	...
	\item Discesa massima (\protect{\href{https://training.olinfo.it/task/discesa}{discesa}})
	\item Police 3 (\protect{\href{https://training.olinfo.it/task/ois_police3}{\ttfamily police3}})
	\item Piano degli studi (\protect{\href{https://training.olinfo.it/task/ois_pianostudi}{pianostudi}})
	\item Police 4 (\protect{\href{https://training.olinfo.it/task/ois_police4}{\ttfamily police4}})
	\item Spiedini di frutta (\protect{\href{https://training.olinfo.it/task/oii_spiedini}{spiedini}})
	\item K-step ancestor (\protect{\href{https://training.olinfo.it/task/ois_treeancestor}{treeancestor}})
\end{itemize}
